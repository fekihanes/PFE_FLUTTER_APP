...
class LivreurinfoComandes extends StatefulWidget {
  const LivreurinfoComandes({super.key});

  @override
  State<LivreurinfoComandes> createState() => _LivreurinfoComandesState();
}

class _LivreurinfoComandesState extends State<LivreurinfoComandes> {
  ...
  Future<void> fetchCommandes(
    ...
    try {
      String baseUrl = '${ApiConfig.baseUrl}employees/Livreur/getinfoCommandes_manager';
      final prefs = await SharedPreferences.getInstance();
