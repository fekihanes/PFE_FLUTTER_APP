...
class ManagerCashierSalesPage extends StatefulWidget {
  final String bakeryId;
  final String employeeId;
  ManagerCashierSalesPage({Key? key, required this.bakeryId, required this.employeeId})
      : super(key: key);

  @override
  State<ManagerCashierSalesPage> createState() => _ManagerCashierSalesPageState();
}

class _ManagerCashierSalesPageState extends State<ManagerCashierSalesPage> {
                              ...
                              child: ExpansionTile(
                                title:  Row(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                        '${sale.receptionTime ?? DateFormat('HH:mm').format(DateTime.now())}'), // 12:24 PM
                                    Text(
